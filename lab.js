...
user.email = 'brian.smith@devmounta.in';
...
let testCat = new Cat('Snookie', '6', 'Orange')
...
let Gandolf = new Wizard('Gandolf', 69, 'intimidating shout');
Gandolf.castSpell("Goku")

//////////////////////////// PROBLEM 14 ////////////////////////////
/*
    Write a class called Phone.
     We'll use it as if we were creating phone objects to keep track of inventory using an app.
...
//Code Here
let phone1 = new Phone("nokia", "brick", 512, "orange", 150)
let phone2 =  new Phone("motorolla", "razr", 1, "silver", 200)
let phone3 =  new Phone("iphone", "3g", 25, "black", 1000)
// console.log(phone2)
...
//Code Here
let myFirstVehicle = new Vehicle(4, 'purple', 1000);
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, 'purple', 17000, 'suzuki', true);
...
//Code Here
let myFirstBoat = new Boat(8, 'purple', 900, 'Yeah, Bouy!', 'yacht', false)
